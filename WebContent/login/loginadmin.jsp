...
<head>
    ...
    <!-- Main CSS-->
    <link href="login/css/mainA.css" rel="stylesheet" media="all">
</head>
        ...
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body">
                    ...
                    <form action="loginadmin.net" method="POST">
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Login" name="username">
                        </div>
