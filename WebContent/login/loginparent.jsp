...
<head>
    ...
    <!-- Main CSS-->
    <link href="login/css/mainF.css" rel="stylesheet" media="all">
</head>
        ...
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body">
                    ...
                    <form action="loginparent.dot" method="POST">
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Login" name="IDP">
                        </div>
