...
<head>
    ...
    <!-- Main CSS-->
    <link href="login/css/mainP.css" rel="stylesheet" media="all">
</head>
        ...
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body">
                    ...
                    <form action="loginprof.do" method="POST">
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Login" name="IDN">
                        </div>
                    
                        <div class="input-group">
                            <input class="input--style-3" type="password" placeholder="Password" name="dateNaissance">
                        </div>
                        <div class="p-t-10">
