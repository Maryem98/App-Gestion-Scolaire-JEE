        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Modifier un parent</h2>
                </div>
                <div class="card-body">
                    <form action="modification.dot" method="POST">
                    <div class="form-row">
                            <div class="name">IDP</div>
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="IDP" value="${parent.IDP }">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row row-space">
                                    <div class="col-2">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="nom" value="${parent.nom }">
                                            <label class="label--desc">Laste name</label>
                                        </div>
                                    </div>
                                    <div class="col-2">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="prenom" value="${parent.prenom }">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="dateNaissance" value="${parent.dateNaissance }">
                                </div>
                            </div>
                        </div>
                         <!--  <div class="form-row">
                                ...
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="classe">
                                            ...
                                            <option>1 ere année</option>
                                            <option>2 eme année</option>
                                            <option>3 eme année</option>
                                        </select>
