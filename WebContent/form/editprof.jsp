        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Modifier un professeur</h2>
                </div>
                <div class="card-body">
                    ...
                    <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="IDN" value="${prof.IDN }">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row row-space">
                                    <div class="col-2">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="nom" value="${prof.nom }">
                                            <label class="label--desc">Laste name</label>
                                        </div>
                                    </div>
                                    <div class="col-2">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="prenom" value="${prof.prenom }">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="dateNaissance" value="${prof.dateNaissance }">
                                </div>
                            </div>
                        </div>
                         <!--  <div class="form-row">
